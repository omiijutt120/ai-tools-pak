...
const guides = [
  ...
  { path: "canva-vs-leonardo-vs-ideogram-pakistan", slugs: ["canva-pro", "leonardo-ai", "ideogram-ai-plus-private"], title: "Canva Pro vs Leonardo AI vs Ideogram AI Plus" },
...
function page(guide, items) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "Article", headline: guide.title, description, dateModified: "2026-08-22", mainEntityOfPage: canonical, publisher: { "@type": "Organization", name: "AI Tools Pak", url: `${SITE}/` } };
  return `<!doctype html>
